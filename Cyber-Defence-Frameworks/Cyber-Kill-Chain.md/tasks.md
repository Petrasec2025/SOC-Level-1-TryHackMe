...
![Introduction Image](https://github.com/user-attachments/assets/cdbe29b7-abd4-4274-a25f-bf4535211350)
...
![Reconnaissance Image](https://github.com/user-attachments/assets/69d20151-2026-4b0a-905b-4a9e4fe8a626)
...
![Weaponization Image](https://github.com/user-attachments/assets/c22c9516-5bec-4258-a910-3d8964a1c8ef)
...
![Delivery Image](https://github.com/user-attachments/assets/e9bc7e1e-30b4-4a25-93c5-354f1cada295)
...
![Installation Image](https://github.com/user-attachments/assets/c86f70fd-0429-430a-a270-165f560f4587)
...
Once the attacker gets access to the system, he would want to reaccess the system if he loses the connection to it or if he got detected and got the initial access removed, or if the system is later patched. He will no longer have access to it. That is when the attacker needs to install a persistent backdoor. A persistent backdoor will let the attacker access the system he compromised in the past. You can check out the [Persistence Room on TryHackMe](https://tryhackme.com/room/persistence) to learn how an attacker can achieve persistence.
...
![Command & Control Image](https://github.com/user-attachments/assets/2d02c9a5-c5f4-4784-8822-04cb8c8d4421)
...
![Practice Analysis Image](https://github.com/user-attachments/assets/4289a466-d47c-433b-b9e8-26e94a0c7545)
...
1. **What is the flag after you complete the static site?**
   - *Answer: THM{CYB3R_K1LL_CH41N}*

---

## Task 10: Conclusion

![Conclusion Image](https://github.com/user-attachments/assets/d45c1025-509c-4167-8318-33cf16579ecc)
