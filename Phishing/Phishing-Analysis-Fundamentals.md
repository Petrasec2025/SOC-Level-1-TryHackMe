# Phishing Analysis Fundamentals Room Walkthrough

![Room Banner](https://github.com/user-attachments/assets/01c1169a-d975-40c1-9b3f-0c92033670e9)

## 🏆 Badges
![Phishing](https://img.shields.io/badge/Phishing-Analysis_Fundamentals-0078D6?style=for-the-badge&logo=shield&logoColor=white)
...
![Show Split View](https://github.com/user-attachments/assets/57f5fbcc-b48a-4067-904c-23da6a269c21)
...
![Email Delivery Diagram](https://github.com/user-attachments/assets/44c03a07-6c2e-4aee-94dd-d0b24ac55f23)
...
![Email Header Fields](https://github.com/user-attachments/assets/997f2088-c847-4f98-96e3-a68b96dd454d)
...
![Yahoo Email Headers](https://github.com/user-attachments/assets/445ebaf5-217d-4722-a2d3-961c763d4039)

Below is a snippet of the raw message for the email sample.

![Raw Email Headers](https://github.com/user-attachments/assets/4089dec8-ba65-4687-b428-4e11d580615c)
...
![Return-Path Header](https://github.com/user-attachments/assets/89ace6d3-ef5f-4ea9-af51-78bd96a58dfe)
...
![ARIN Information](https://github.com/user-attachments/assets/56a8632d-ab76-47d3-bbfd-a54da1138779)
...
![Text Email Example](https://github.com/user-attachments/assets/bd441897-53e6-47bc-8284-2838fd3efd4a)

Below is an example of the HTML formatted email.

![HTML Email Example](https://github.com/user-attachments/assets/578b1373-0605-4920-a2ba-b386677b76af)
...
![Protonmail HTML View](https://github.com/user-attachments/assets/1a81eb8f-bfa9-464f-b9e5-a72b780c01a0)

A snippet of the HTML code is shown below.

![HTML Code Snippet](https://github.com/user-attachments/assets/bfed9316-df7d-49a3-8b7b-7c549ba8537d)

In this specific email web client, Protonmail, the option to switch back to HTML is called "View rendered HTML".

![View Rendered HTML](https://github.com/user-attachments/assets/30439ae3-2255-47d0-85f3-dd93722bedf5)
...
![Email with Attachment](https://github.com/user-attachments/assets/57241a84-7ead-43e9-be84-47a5b4f28845)
...
![Attachment Source Code](https://github.com/user-attachments/assets/edf413ce-afa3-428c-85d3-eba5516a9e7f)
...
![Blocked Image URI](https://github.com/user-attachments/assets/588a1e4c-63fa-4667-8960-3d27107b1db3)
...
![PDF Attachment Name](https://github.com/user-attachments/assets/98bb41c2-c0c8-493e-af0b-f79bea4a88c7)

**Answer:** `Payment-updateid.pdf`

**5.3 In the attached virtual machine, view the information in email2.txt and reconstruct the PDF using the base64 data. What is the text within the PDF?**
![Terminal Navigation](https://github.com/user-attachments/assets/5a87adac-7948-48b9-a202-6434d1cef352)

![Email Samples Directory](https://github.com/user-attachments/assets/6290c559-4452-469f-8cc7-01df5d95aef0)
...
![Directory Navigation](https://github.com/user-attachments/assets/8b1c92ab-d9c0-48e6-aca8-f23a01a658fa)

![Email Samples Files](https://github.com/user-attachments/assets/0dbb5458-d3e6-46b6-88a2-32dbb498fda4)

Create new file testemail.txt and Save only the Base64 content.

![Base64 Content](https://github.com/user-attachments/assets/566a6fe8-df5b-43e2-b469-110c3dd58d30)

Go back to the terminal and List the files in the directory.

![Terminal Files](https://github.com/user-attachments/assets/fe738129-f41d-428c-8680-d45f34291c85)

`cat email2.txt | base64 -d > testemail.pdf`: Reads the content of email2.txt, decodes the Base64-encoded content, and saves it as a file named testemail.pdf.

![Base64 Decoding](https://github.com/user-attachments/assets/da0a16e5-6a2b-4b1b-9393-ba2013d758ad)

Go Back to the Email Samples Folder and open testemail.pdf.

![PDF File](https://github.com/user-attachments/assets/869c9e72-a314-41d4-a86c-213b5e6177aa)

We can see the flag.

![PDF Content](https://github.com/user-attachments/assets/f890961b-1b92-490f-95fc-623774e135a4)
...
![Email3 Analysis](https://github.com/user-attachments/assets/c581af35-3e7d-4a1d-8c0e-a48075fc5e28)
...
![From Field](https://github.com/user-attachments/assets/4dd22bb9-5196-49f2-84e0-11ae6fe6464d)

![Base64 Encoded Subject](https://github.com/user-attachments/assets/c6325f86-c869-4c41-b838-31d651f12125)

The part between =?UTF-8?B? and ?= is the Base64 encoded text.

![Base64 Decoding Process](https://github.com/user-attachments/assets/65c4019b-cb54-4df4-b123-53d7519b2f84)

Using CyberChef to decode from Base64.

![CyberChef Decoding](https://github.com/user-attachments/assets/dd4996b8-89f4-4093-98f5-956b222cdc1e)

Or Use Thunderbird email client to view the decoded sender name.

![Thunderbird View](https://github.com/user-attachments/assets/b305f8c9-9a89-4391-83c1-bba57013516f)

**Answer:** `Home Depot`

**6.2 What is the sender's email?**
![Sender Email](https://github.com/user-attachments/assets/13f5e9f5-964f-4f63-9288-67ee439ed5d6)

**Answer:** `support@teckbe.com`

**6.3 What is the subject line?**
![Subject Line](https://github.com/user-attachments/assets/f6d5a813-120f-4765-b06d-69c86e4cecad)

![Encoded Subject](https://github.com/user-attachments/assets/738d0635-4f0a-4a41-aa70-60a3af628536)

- `=?UTF-8?B?…?=`
- UTF-8 indicates the encoding format.
- B (Base64) indicates the text is Base64 encoded.

![Thunderbird Subject](https://github.com/user-attachments/assets/cf31de37-5473-4dc5-b724-a5f06a196c67)

Or Using CyberChef.

![CyberChef Subject Decoding](https://github.com/user-attachments/assets/8b7a7e23-c419-4344-a80b-1805378112ac)

**Answer:** `Order Placed: Your Order ID OD2321657089291 Placed Successfully`

**6.4 What is the URL link for — CLICK HERE? (Enter the defanged URL)**
![Click Here Link](https://github.com/user-attachments/assets/54b7ffd6-575e-425c-8f9a-6ac04f721bfa)

![Encoded URL](https://github.com/user-attachments/assets/b9e84d9f-1756-4149-9cd2-b3bdbf5e3793)
...
![CyberChef URL Processing](https://github.com/user-attachments/assets/ed7a5cef-d16d-4cb1-a03e-0a247fb6b28a)

![Defanged URL](https://github.com/user-attachments/assets/4bff22da-4469-4b5f-86dd-7f8df20cc686)
...
![BEC Definition](https://github.com/user-attachments/assets/f4850261-fdaf-43d9-bad5-788abcbf21ad)

---

## 🎯 Final Badges
![Email Protocols](https://img.shields.io/badge/Email_Protocols-SMTP|IMAP|POP3-FF69B4?style=for-the-badge)
![Headers](https://img.shields.io/badge/Headers-Analysis-000080?style=for-the-badge)
![Room](https://img.shields.io/badge/Room-Phishing_Fundamentals-FF4500?style=for-the-badge)
![Attachments](https://img.shields.io/badge/Attachments-Base64_Decoding-008080?style=for-the-badge)

## Conclusion

This room provided comprehensive foundational knowledge for analyzing phishing emails, covering email protocols, header analysis, body examination, and common phishing techniques. The hands-on exercises with real email samples helped reinforce practical skills in identifying suspicious emails, decoding attachments, and defanging malicious URLs - essential skills for any SOC analyst dealing with email-based threats.

---

**Room Link:** [https://tryhackme.com/room/phishingemails1](https://tryhackme.com/room/phishingemails1tryoe)
