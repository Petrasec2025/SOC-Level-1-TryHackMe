...
![TryHackMe](https://img.shields.io/badge/TryHackMe-Intro%20to%20Endpoint%20Security-red) 
...
This room provided a comprehensive introduction to endpoint security monitoring, covering fundamental concepts, essential tools, and practical investigation techniques. Through hands-on experience with core Windows processes, logging tools like Sysmon and OSQuery, and EDR solutions like Wazuh, we gained valuable insights into detecting and responding to security threats at the endpoint level.

The investigation activity demonstrated the importance of baselining normal system behavior and correlating events across different log sources to identify malicious activity effectively.

---

**Flag:** `THM{3ndp01nt_s3cur1ty!}`
