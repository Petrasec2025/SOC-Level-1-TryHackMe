...
![Room Banner](https://github.com/user-attachments/assets/fdfbe5a8-e5b0-48f8-9683-a09c5056a9a0)
...
![Prerequisites](https://github.com/user-attachments/assets/70f96ec0-4714-4e71-b9ec-c45c344f20bc)
...
![Email Context](https://github.com/user-attachments/assets/f68a0673-afd5-4860-b7f2-2d3576353a11)
...
![Manual Analysis](https://github.com/user-attachments/assets/8e4f5847-d214-437b-9b0c-90d80df41b33)
...
![Thunderbird Analysis](https://github.com/user-attachments/assets/adedeb20-a534-4c77-a9f4-110e3471b06e)

![Email Content](https://github.com/user-attachments/assets/1447e6b6-1cc6-410a-a51f-4d5c89927bd5)

![Attachment Details](https://github.com/user-attachments/assets/8f9e7ad8-2c5a-49bb-bf04-98b37569dcd6)

![File Extraction](https://github.com/user-attachments/assets/e9647b21-5efd-4ff7-9c29-7dc8ebb4c1cd)

Once the payload from the encrypted archive is extracted, use lnkparse to extract the information inside the payload.

![LNK Parse](https://github.com/user-attachments/assets/39a98599-083b-4f4f-80ed-2eff857ecdc8)
...
![Email Header Analysis](https://github.com/user-attachments/assets/28506051-8b5f-4973-85c3-9a36a2bff55d)
...
![LNK Parse Results](https://github.com/user-attachments/assets/39c3a538-0703-493f-a2d6-804d64156627)

Decode the strings in cyberchef.

![Base64 Decoding](https://github.com/user-attachments/assets/f4f447eb-43b9-4443-b5b8-8b2aa1b99f77)
...
![JQ Cheatsheet](https://github.com/user-attachments/assets/e5247bae-4cbf-4331-bb8f-0b712e1c4bc7)
...
![JQ Command](https://github.com/user-attachments/assets/c5ffaf87-c586-4bb9-b06b-3faecb8ee3fe)

![JQ Output](https://github.com/user-attachments/assets/1492e0e5-1491-4a05-b3b3-99d064187172)
...
![Domain Extraction Command](https://github.com/user-attachments/assets/edd2f255-b798-4687-a3f9-2c64af80c865)

We see two domains that were being used for hosting a file and acting as a C2 server.

![Domain Results](https://github.com/user-attachments/assets/fd1ef752-c9ad-4bfa-bd4d-befc03fcaa72)
...
![SQLite Command](https://github.com/user-attachments/assets/b630d782-dcfb-4b03-b147-07afcd078344)

It can be seen that the binary "sq3.exe" was used to download a file named "plum.sqlite"

![SQLite Results](https://github.com/user-attachments/assets/54d95a6e-7673-4b71-bffa-c15e1c5a84fc)
...
![Exfiltration Command](https://github.com/user-attachments/assets/c86c6efd-4677-4685-ba53-3b53d6b53708)

We can find all the answers for the remaining questions in this task from the result of the command.

![Exfiltration Results](https://github.com/user-attachments/assets/5a986015-65c3-457d-9ae6-f45557ae49ec)
...
![KeePass Research](https://github.com/user-attachments/assets/540e45de-9ddc-4b42-ac8e-f6a566f43be2)
...
![HTTP Filter](https://github.com/user-attachments/assets/fe509335-cd2e-42d6-bfbf-2fb2279b597c)
...
![Python Server](https://github.com/user-attachments/assets/cced0c7f-d3c8-4765-be6e-2a4ef715d3dc)
...
![SQLite Filter](https://github.com/user-attachments/assets/2a3c5b82-9fc8-485d-9683-825880cd061a)
...
![SQL Data](https://github.com/user-attachments/assets/fc8a8ce3-79b2-421c-b980-906b018f7b8d)
...
![Decimal Data](https://github.com/user-attachments/assets/f77f79ac-b636-424a-b0a4-5846985831de)

Used "Magic" to initially identify what type of characters they were.

![Magic Analysis](https://github.com/user-attachments/assets/ba287c84-1052-405f-86e7-f0b24ee1a469)

Using "From Decimal" as the recipe, the master password for the exfiltrated file is now retrieved.

![Password Recovery](https://github.com/user-attachments/assets/c748eda3-94a1-4b21-9eb8-67f5e94db176)
...
![Wireshark Filter](https://github.com/user-attachments/assets/c1762267-4625-476b-b9bd-32fcc2e25313)

Added to the filter is the destination IP of the exfiltrated file.

![DNS Filter Results](https://github.com/user-attachments/assets/8ea12fab-64c8-4827-b4da-5749cf9e4213)
...
![TShark Command](https://github.com/user-attachments/assets/47176065-2d58-4048-8236-7a934695acec)

![TShark Results](https://github.com/user-attachments/assets/d5b2fcf5-6336-4ed6-9f04-f1df2eb0d0e3)
...
![Cleaned TShark](https://github.com/user-attachments/assets/8577a300-ef2f-477e-a70d-98b6d965d273)

We need to remove empty spaces or newlines, so we use "tr" to make the output in one line of text.

![Final Hex Data](https://github.com/user-attachments/assets/91e32a17-08c0-4e75-bb44-32a12d42c6f2)

We can also save the result into a text file.

![Save Output](https://github.com/user-attachments/assets/7059a7a9-08e0-4e24-a3d6-f281d08a2e98)

Or just copy and paste the strings in CyberChef.

![Hex Decoding](https://github.com/user-attachments/assets/d2b2da73-6f56-4895-a41f-0d88777d9c9c)
...
![KeePass File](https://github.com/user-attachments/assets/23461080-2f53-4453-afc1-5887d9be5f13)

With the master password retrieved, we can open the database and see what's inside.

![KeePass Contents](https://github.com/user-attachments/assets/e61cb192-1a27-4cff-9272-049bb0677adf)
...
![Endpoint Analysis](https://img.shields.io/badge/Endpoint-Analysis-blue)
![Network Forensics](https://img.shields.io/badge/Network-Forensics-orange)
...
![Data Exfiltration](https://img.shields.io/badge/Data-Exfiltration-lightgrey)
![Incident Response](https://img.shields.io/badge/Incident-Response-9cf)
...
**🔍 Comprehensive Investigation Completed** | **✅ Full Attack Chain Documented** | **🛡️ Advanced Forensics Applied**

*This investigation revealed sophisticated TTPs including encoded PowerShell execution, host enumeration, and covert DNS exfiltration techniques.*
