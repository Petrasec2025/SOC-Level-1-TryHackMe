# Introduction to SIEM Room Walkthrough

![Room Banner](https://github.com/user-attachments/assets/a913dd7c-aef7-42ec-9a65-9131374e4b6b)

## 🏆 Badges
![SIEM](https://img.shields.io/badge/SIEM-Introduction-0078D6?style=for-the-badge&logo=shield&logoColor=white)
![Security](https://img.shields.io/badge/Security-Monitoring-00C800?style=for-the-badge&logo=eye&logoColor=white)
...
**Room link:** [Introduction to SIEM](https://tryhackme.com/room/introtosiem)
...
![Network Diagram](https://github.com/user-attachments/assets/6e3cc5f5-c32b-4619-8763-61ba78be634a)
...
![SIEM Importance](https://github.com/user-attachments/assets/987eb3cd-a5d4-468c-ad41-6eccc381471f)
...
![Cron Log Sample](https://github.com/user-attachments/assets/41aaf8eb-dcdb-4c5d-8d32-a1d192eea471)
...
![Apache Logs](https://github.com/user-attachments/assets/df292bc6-34f4-423f-b10c-858772dfc6db)

![Apache Logs Detailed](https://github.com/user-attachments/assets/8b2d0bca-2bd8-4cdd-875b-fce53373b6fc)
...
![Splunk Log Ingestion](https://github.com/user-attachments/assets/93499e9d-9087-4356-8dea-167204f634ea)
...
![SOC Ecosystem](https://github.com/user-attachments/assets/97f2dd0b-0272-45b0-bb69-a90ee0f2782b)
...
![Qradar Dashboard](https://github.com/user-attachments/assets/22176a50-5cfd-43db-9289-4a31f58815ea)
...
![Lab Dashboard](https://github.com/user-attachments/assets/e56b8adc-8890-4613-83cc-f8f607cb8fdf)

Click on "Start Suspicious Activity"

![Start Suspicious Activity](https://github.com/user-attachments/assets/d48629bb-b6ce-4c2c-9776-a177efbe3ae4)

### Question 1: Click on Start Suspicious Activity, which process caused the alert?
**Answer:** `cudominer.exe`

![Suspicious Process](https://github.com/user-attachments/assets/b9ba5a40-d7db-4692-9076-37d599a27dba)

cudominer.exe process is highlighted which is very suspicious.

![Process Highlighted](https://github.com/user-attachments/assets/7f655cd7-bf96-4074-8598-d0b9ffbd775b)

Navigate to the event logs and locate the event that triggered the alert.

![Event Logs](https://github.com/user-attachments/assets/81c253ac-4245-4853-9a13-c723d6cbbb07)

Below shows where the suspicious process is.

![Suspicious Process Location](https://github.com/user-attachments/assets/34877b6f-c418-4473-bcbd-6f2ceb8ec719)

Click on the event to get more details.

![Event Details](https://github.com/user-attachments/assets/77a5d2f5-7159-4652-acb0-dbbe5e0b5100)

Next is to click on the rule ID that triggered the alert.

![Rule ID](https://github.com/user-attachments/assets/0e289d2f-c7d6-495d-9d95-d63ed986711c)

The following shows the rule.

![Rule Details](https://github.com/user-attachments/assets/3ed77a7a-ad28-40a0-b0bb-89768a844f4c)
...
![Alert Decision](https://github.com/user-attachments/assets/30176906-4f8a-475a-8d87-972fb97a609f)

Based from the information gathered, the alert is categorized as True-positive.

![True Positive](https://github.com/user-attachments/assets/8e0b8dde-d52f-47ad-b5ba-00e121e02839)

![Flag Display](https://github.com/user-attachments/assets/d4e99ed4-9d0c-462f-9d9d-7f7855f50ad6)
...
## 🎯 Final Badges
![Monitoring](https://img.shields.io/badge/Monitoring-Log_Analysis-FF69B4?style=for-the-badge)
![Alerting](https://img.shields.io/badge/Alerting-Correlation_Rules-000080?style=for-the-badge)
![Room](https://img.shields.io/badge/Room-SIEM_Intro-FF4500?style=for-the-badge)
![Investigation](https://img.shields.io/badge/Investigation-Threat_Detection-008080?style=for-the-badge)
